    ...
    <nav class="container-shell flex min-h-[76px] items-center gap-4" aria-label="Navigasi utama">
      <NuxtLink to="/" class="mr-auto flex items-center gap-3" @click="closeMenu">
        ...
        <span>
          ...
          <span class="block text-xs text-slate-500 dark:text-white/55">Build · Design · Optimize</span>
        </span>
      </NuxtLink>
      ...
      <div class="hidden lg:block"><UiCtaLink :href="siteConfig.cta.href">Konsultasi gratis</UiCtaLink></div>
